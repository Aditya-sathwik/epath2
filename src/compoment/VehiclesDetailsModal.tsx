...
const VehiclesDetailsModal = ({ isVisible, onPressCancel, data }: Props) => {
        ...
        <View style={{ paddingHorizontal: 10, paddingVertical: 0 }}>
          <View style={styles.headerCard}>
            ...
            <View style={{ marginLeft: 15 }}>
              <Text style={styles.profileText}>{data?.owner}</Text>
              <View>
                <View style={styles.bodyView}>
                  <Image
                    source={icons.sportscar}
                    style={styles.sportscarIcon}
                  />
                ...
                <View style={styles.footerView}>
                  <Image
                    source={icons.registration}
                    style={styles.sportscarIcon}
                  />
                  <View style={styles.listView}>
                    <Text style={styles.listText}>{data?.rc_number}</Text>
                  </View>
                </View>
                {/* <View style={styles.footerView}>
                  <Image source={icons.mail} style={styles.listIcon} />
                  <View style={styles.listView}>
                    <Text style={styles.listText}> janika11@gmail.com</Text>
                  </View>
                </View> */}
                {/* <View style={styles.footerView}>
                  <Image source={icons.callIcon} style={styles.listIcon} />
                  <View style={styles.listView}>
                    <Text style={styles.listText}>9675263574</Text>
                  </View>
                </View> */}
              </View>
            </View>
...
export default VehiclesDetailsModal;
